...
-- AddForeignKey
ALTER TABLE `user_times_intervals` ADD CONSTRAINT `user_times_intervals_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
