...
-- DropForeignKey
ALTER TABLE `user_times_intervals` DROP FOREIGN KEY `user_times_intervals_user_id_fkey`;
...
-- RenameIndex
ALTER TABLE `user_times_intervals` RENAME INDEX `user_times_intervals_user_id_fkey` TO `user_times_intervals_user_id_idx`;
